...
contract IQLend is IMorphoStaticTyping {
        ...
        returns (uint256, uint256)
    {
        ...
        require(market[id].totalSupplyAssets + assets <= supplyCaps[id] || supplyCaps[id] == 0, "supply cap reached");
        ...
        returns (uint256, uint256)
    {
        ...
        require(market[id].totalBorrowAssets + assets <= borrowCaps[id] || borrowCaps[id] == 0, "borrow cap reached");
